...
Revision ID: 8001ce3060c2
Revises: a3173fd2475e
Create Date: 2025-05-22 10:41:49.105708
...
revision = '8001ce3060c2'
down_revision = 'a3173fd2475e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.CheckConstraint('graden BETWEEN 1 and 12', name='garde_between_1_12'),
